...
public class abilityControl : MonoBehaviour
{
    ...
    void ability()
    {
        ...
        // if (Input.GetKeyDown(KeyCode.F) && HBControl.currentMP >= 10f && cdFlash.GetComponent<Text>().text == ""){
        //     flash();
        //     HBControl.currentMP -= 10f;
        ...
        // if (Input.GetKeyDown(KeyCode.R) && HBControl.currentMP >= 10f && cdAttack.GetComponent<Text>().text == ""){
