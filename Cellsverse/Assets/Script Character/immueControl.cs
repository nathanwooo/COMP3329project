...
public class immueControl : MonoBehaviour
{
    ...
    void EnableCollider(string action)
    {
        ...
        if (action == "sword_down"){
            tf.Find("weapon_sword_down").GetComponent<Collider2D>().enabled = true;
        }
        if (action == "sword_left"){
            tf.Find("weapon_sword_side").GetComponent<Collider2D>().enabled = true;
        }
        if (action == "sword_right"){
            tf.Find("weapon_sword_right").GetComponent<Collider2D>().enabled = true;
        }
    ...
    void DisableCollider(string action)
    {
        ...
        if (action == "sword_down"){
            tf.Find("weapon_sword_down").GetComponent<Collider2D>().enabled = false;
        }
        if (action == "sword_left"){
            tf.Find("weapon_sword_side").GetComponent<Collider2D>().enabled = false;
        }
        if (action == "sword_right"){
